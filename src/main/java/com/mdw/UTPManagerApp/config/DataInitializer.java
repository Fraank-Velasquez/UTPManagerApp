...
public class DataInitializer {
    ...
    public CommandLineRunner initData(
        ...
        return args -> {
            ...
            if (!userRepo.existsByUsername("maria.lopez")) {
                userRepo.save(new Usuario("maria.lopez", encoder.encode("user123"), user));
                System.out.println("Usuario 'maria.lopez' creado");
            }
            ...
            if (proyectoRepo.findByPropietarioUsername("admin").isEmpty()) {
                ...
                p1.setNombre("Sistema de Gestión Académica");
                p1.setDescripcion("Desarrollo de un sistema web para gestionar notas, asistencias y horarios de la facultad de ingeniería.");
                ...
                p2.setNombre("Rediseño Portal Web UTP");
                p2.setDescripcion("Modernización del portal institucional con nueva identidad visual y mejora de accesibilidad.");
                ...
                p3.setDescripcion("Aplicación para reserva de libros, consulta de disponibilidad y renovación de préstamos.");
                ...
                a1.setDescripcion("Crear el diagrama entidad-relación para las tablas de estudiantes, cursos y notas.");
                ...
                a2.setDescripcion("Desarrollar el sistema de login con Spring Security para los usuarios del sistema académico.");
                ...
                a3.setDescripcion("Sesiones de prueba con estudiantes y docentes para validar la interfaz del portal rediseñado.");
                ...
                a4.setDescripcion("Presentación del 50% del proyecto ante el comité directivo de la universidad.");
